...
async def get_buying_list(message: Message):
    await message.answer("Название: Картинка 1 | Описание: Кот хоба | Цена: 100 рубликов")
    photo1 = FSInputFile("66. Refining the bot\\Кот хоба.jpg")
    await message.answer_photo(photo1)

    await message.answer("Название: Картинка 2 | Описание: Кот без сигнала | Цена: 200 рубликов")
    photo2 = FSInputFile("66. Refining the bot\\Кот без сигнала.jpg")
    await message.answer_photo(photo2)

    await message.answer("Название: Картинка 3 | Описание: Грустный кот | Цена: 500 рубликов")
    photo3 = FSInputFile("66. Refining the bot\\Грустный кот.jpg")
    await message.answer_photo(photo3)

    await message.answer("Название: Картинка 4 | Описание: Гига кот | Цена: 1000 рубликов")
    photo4 = FSInputFile("66. Refining the bot\\Гига кот.jpg")
    await message.answer_photo(photo4, reply_markup=buttons_buy)
